...
- **Product docs and handoff**: English/Chinese README, both roadmaps, current handoff, and the sanitized validation report describe disconnect-safe project-local M2, deterministic reconnect/migration, exact safety pauses, the real Codex/Claude PASS, and future A2A/remote/global/client/transcript scope.
