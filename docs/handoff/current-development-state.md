...
Fresh Task 11 verification after the final cleanup/idempotency fixes is 204 focused tests, 711 daemon regressions, and 2,566 full-suite tests passing with one skip. Compileall and `git diff --check` pass.
