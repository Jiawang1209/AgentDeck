...
详细字段契约见 `docs/contracts/project-view-schema.md`。当前契约版本为 `schema_version: "project-view/v1"`。GUI、自然语言入口和恢复工具应优先按该契约消费 `agentdeck status`，不要把 tmux pane 或 state 文件当成第二套状态源。
