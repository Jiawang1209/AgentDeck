...
- Run start contract 见 `docs/contracts/run-schema.md`；`agentdeck contract run --example` 会返回稳定 run_start 示例，字段常量、example fixture 和 `validate_run_start_contract()` 都在 `src/agentdeck/contracts.py`。
