...
def leader_chat_capability_card() -> dict[str, object]:
    capability_specs = [
        ...
        },
        {
            ...
            "description": "Inspect visible tmux agent panes or suggest explicit agent spawn/send/stop commands.",
            "example_messages": ["查看 runtime", "查看终端", "启动 planner", "发送给 planner：继续", "停止 planner"],
