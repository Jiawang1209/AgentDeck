...
from agentdeck.application.approval_cancellation import cancel_worker_for_caller
from agentdeck.application.approval_records import (
    ApprovalContext, PermissionBridgeResult,
)
...
class ApprovalService:
    ...
    async def bridge_attempt(
        ...
        try:
            ...
            await cancel_worker_for_caller(worker, handle)
            raise
